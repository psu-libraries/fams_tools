class GpaIntegrateJob < ApplicationJob
  ...
  def integrate(params, _user_uploaded = true)
    ...
    gpa_importer = GpaData::ImportGpaData.new(f_path)
    gpa_importer.import
    gpa_xml_builder = GpaData::GpaXmlBuilder.new.xmls_enumerator
    gpa_integration = ActivityInsight::IntegrateData.new(gpa_xml_builder, params[:target], :post)
