...
RSpec.describe Committee, type: :model do
  ...
  describe 'database columns' do
    ...
    it { is_expected.to have_db_column(:type_of_work).of_type(:string) }
    it { is_expected.to have_db_column(:stage_of_completion).of_type(:string) }
    it { is_expected.to have_db_column(:start_year).of_type(:integer) }
    it { is_expected.to have_db_column(:completion_year).of_type(:integer) }
